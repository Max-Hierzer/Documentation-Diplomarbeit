...
\section{MyPolls}
\subsection{Purpose}
The MyPolls view is the central location from which users can view and manage all polls they have created. It provides access to the links for the polls as well as a delete option for them. \\
