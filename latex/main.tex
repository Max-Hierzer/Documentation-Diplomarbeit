...
The first section contains general information about the poll, including its title, description, poll type, group selection, start and end times and image upload. The poll type is controlled by two selectors, which define whether the poll is public and anonymous. \\\\ 
