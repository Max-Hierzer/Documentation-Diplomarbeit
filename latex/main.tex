...
What did we do?
Konzeption und Design, Implementierung, Einrichtung Github-Repo, Tests, Abstimmung mit Projektpartner
...
Planung und Organisation:
	- Projektorganisation über Github Projects -> Tasks in Form von Issues und Milestones
	- grober Plan welcher in Sprint unterteilt war. In jedem Sprint wurden konkrete Teilziele definiert.
Meetings und Kommunikation:
	- Wöchentliche Meetings(intern), Lösen von technischen und nicht technischen Problemen, neue Anforderung
	- alle 2 oder 3 wochen meeting mit auftraggeber
Vorteile & Herausforderungen:

	Vorteile: Die regelmäßigen Meetings förderten die frühzeitige Identifikation von Problemen und ermöglichten schnelles Reagieren auf Änderungen. GitHub erleichterte die Zusammenarbeit, auch bei verteiltem Arbeiten.

	Herausforderungen: Die Abstimmung zwischen verschiedenen Beteiligten führte gelegentlich zu Missverständnissen bezüglich Anforderungen. Zudem stellte die Integration von Sicherheitsanforderungen (z. B. Datenschutz, Manipulationssicherheit) eine technische Herausforderung dar.

Because the clients said so.\\\\
